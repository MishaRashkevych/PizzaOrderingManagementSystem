    ...
    public partial class initMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Pizzas",
                columns: new[] { "Id", "Crust", "IsVeg", "Name", "Price", "Speciality" },
                values: new object[,]
                {
                    { 1, "Meat", false, "Margherita", 20.0, "Plain" },
                    { 2, "Standart", true, "Cheese N Corn", 25.0, "Cheezy" },
                    { 3, "Cheezy", false, "Chicken Pepperoni", 20.0, "Spicy" }
                });
